...
import { IRouteComponentProps, useModel, useIntl } from 'umi'
  ...
  return (
    <ConfigProvider
      value={{
        compDefaultProps: {},
        // @ts-ignore
        localeConfig: { localeData },
      }}
    >
      <SettingsContextProvider value={{ settings, updateSettings }}>{children}</SettingsContextProvider>
    </ConfigProvider>
  )
}
